...
- Return the SQL using the provided JSON schema.
        ...
        config=types.GenerateContentConfig(
            ...
            response_schema={
                ...
                "properties": {
                    "sql": {
                        "type": "STRING",
                        "description": "The single SELECT SQL query that answers the user's question."
                    }
                },
                "required": ["sql"]
            }
...
def is_safe(sql):
    ...
    forbidden_pattern = r"\b(DROP|DELETE|TRUNCATE|ALTER|UPDATE|INSERT|CREATE|REPLACE|GRANT|REVOKE)\b"
